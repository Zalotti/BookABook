package br.edu.ifsp.arq.dw2s6.bookabook.exceptionhandler;
...
import br.edu.ifsp.arq.dw2s6.bookabook.exception.NonExistentOrInactiveUserException;


@ControllerAdvice
public class BookABookExceptionHandler extends ResponseEntityExceptionHandler{
